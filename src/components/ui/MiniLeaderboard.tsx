    ...
    <div className="w-full max-w-4xl mx-auto mt-32 p-1 border border-white/5 bg-white/[0.02] rounded-3xl backdrop-blur-md">
      <div className="p-8 border-b border-white/5 flex justify-between items-center">
        <div className="flex items-center gap-3">
          ...
          <h3 className="font-[family-name:var(--font-outfit)] text-2xl font-black uppercase">Top Flight Pilots</h3>
        </div>
        ...
        {topPilots.map((pilot, i) => (
          <div key={i} className="flex items-center justify-between p-6 hover:bg-white/[0.02] transition-colors">
            <div className="flex items-center gap-6">
              ...
              <div>
                <p className="font-bold text-lg text-white">{pilot.name}</p>
                <p className="font-mono text-[10px] uppercase tracking-widest" style={{ color: pilot.color }}>{pilot.rank} Tier</p>
              </div>
            </div>
            <div className="text-right">
              <p className="font-mono font-bold text-[#7ed957]">{pilot.xp} XP</p>
